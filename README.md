...
Stereotype annotations used: @Service, @Component, @Profile, @Primary, @Controller, @Autowired, @Qualifier and test annotations. For more info, read the project comments at each class, starting from the @SpringBootApplication Main class.<br>
